...
// Make changes to FLLocation.m instead.

#import "_FLLocation.h"

const struct FLLocationAttributes FLLocationAttributes = {
	.address = @"address",
	.latitude = @"latitude",
	.longitude = @"longitude",
};

const struct FLLocationRelationships FLLocationRelationships = {
	.annotation = @"annotation",
};

@implementation FLLocationID
@end

@implementation _FLLocation
...
- (FLLocationID*)objectID {
	return (FLLocationID*)[super objectID];
}
